...
const (
	...
	CommentTypeAddParentIssue    // 39 add parent issue
	CommentTypeRemoveParentIssue // 40 remove parent issue
	CommentTypeAddSubIssue       // 41 add sub-issue
	CommentTypeRemoveSubIssue    // 42 remove sub-issue
)
