...
func Test_FederationKeyID(t *testing.T) {
	...
	_, err = federation_key.NewKeyID("https://forgejo.org/api/v1/activitypub/actor/1")
	require.Error(t, err, "expected error for missing fragment and/or query identifier")
