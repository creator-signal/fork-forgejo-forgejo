...
func TestSearchRepositoryIDsByCondition(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			repoIDs: []int64{1, 3, 4, 8, 9, 10, 11, 12, 14, 17, 18, 21, 23, 25, 27, 29, 32, 33, 34, 35, 36, 37, 38, 40, 42, 44, 45, 46, 47, 48, 49, 50, 51, 53, 57, 58, 60, 61, 62, 63, 66, 1001, 1059},
		},
		{
			user:    unittest.AssertExistsAndLoadBean(t, &user.User{ID: 5}),
			repoIDs: []int64{1, 4, 8, 9, 10, 11, 12, 14, 17, 18, 21, 23, 25, 27, 29, 32, 33, 34, 35, 36, 37, 38, 40, 42, 44, 45, 46, 47, 48, 49, 50, 51, 53, 57, 58, 60, 61, 62, 63, 66, 1001, 1059},
		},
	}
