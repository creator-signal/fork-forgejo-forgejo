...
require (
	...
	code.forgejo.org/forgejo/runner/v9 v9.1.1
...
replace code.forgejo.org/forgejo/runner/v9 => code.forgejo.org/forgejo/runner/v9 v9.1.2-0.20250901115124-a334431107da
