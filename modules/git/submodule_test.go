...
func TestGetRefURL(t *testing.T) {
	kases := []struct {
		...
		{"git://github.com/user1/repo1", "/", "user1/repò2", "", "http://github.com/user1/repo1"},
		{"https://localhost/user1/repo1.git", "/", "user1/repò2", "", "https://localhost/user1/repo1"},
		...
		{"https://gitea.com:3000/user1/repo1.git", "https://127.0.0.1:3000/", "user/repò2", "", "https://gitea.com:3000/user1/repo1"},
		{"https://example.gitea.com/gitea/user1/repo1.git", "https://example.gitea.com/gitea/", "", "user/repò2", "https://example.gitea.com/gitea/user1/repo1"},
		...
		{"../path/to/repo.git/", "https://localhost/", "user/repò2", "", "https://localhost/user/path/to/repo.git"},
