...
// func TestActionsAPIGetJobsLogs(t *testing.T) {
// 	defer tests.PrepareTestEnv(t)()
...
// 			jobIDs []int64
// 		}{
// 			{4, []int64{192, 193, 194, 195, 196, 197, 198, 199, 200}},
// 			{1, []int64{292, 393}},
// 		} {
// 			repo := unittest.AssertExistsAndLoadBean(t, &repo_model.Repository{ID: setup.repoID})
// 			user := unittest.AssertExistsAndLoadBean(t, &user_model.User{ID: repo.OwnerID})
...
// 			for _, jobID := range setup.jobIDs {
// 				req := NewRequest(t, http.MethodGet,
// 					fmt.Sprintf("/api/v1/repos/%s/%s/jobs/%d/logs",
// 						repo.OwnerName, repo.Name, jobID,
// 					),
// 				).AddTokenAuth(token)
// 				res := MakeRequest(t, req, http.StatusOK)
// 				assert.NotEmpty(t, res.Body.String())
// 				assert.True(t, strings.HasSuffix(res.Header().Get("Content-Disposition"), ".log\""))
// 			}
// 		}
// 	})
...
// 	t.Run("Wrong Job ID", func(t *testing.T) {
// 		req := NewRequest(t, http.MethodGet,
// 			fmt.Sprintf("/api/v1/repos/%s/%s/jobs/%d/logs",
// 				repo.OwnerName, repo.Name, jobID+9999,
// 			),
// 		).AddTokenAuth(token)
// 		MakeRequest(t, req, http.StatusNotFound)
// 	})
...
// 		req := NewRequest(t, http.MethodGet,
// 			fmt.Sprintf("/api/v1/repos/%s/%s/jobs/%d/logs",
// 				repo.OwnerName, repo.Name+"_wrong_repo", jobID,
// 			),
// 		).AddTokenAuth(token)
// 		MakeRequest(t, req, http.StatusNotFound)
// 	})
...
// 		req := NewRequest(t, http.MethodGet,
// 			fmt.Sprintf("/api/v1/repos/%s/%s/jobs/%d/logs",
// 				repo.OwnerName+"_wrong_owner", repo.Name, jobID,
// 			),
// 		).AddTokenAuth(token)
// 		MakeRequest(t, req, http.StatusNotFound)
// 	})
