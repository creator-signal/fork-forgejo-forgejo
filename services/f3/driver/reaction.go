...
func (o *reaction) Put(ctx context.Context) f3_id.NodeID {
	...
	case f3_kind.KindIssue, f3_kind.KindPullRequest, f3_kind.KindReview:
		break
	case f3_kind.KindComment, f3_kind.KindReviewComment:
...
func (o *reaction) Delete(ctx context.Context) {
	...
	if _, err := db.DeleteByID[issues_model.Reaction](ctx, o.forgejoReaction.ID); err != nil {
		panic(err)
	}
}
