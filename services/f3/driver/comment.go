...
import (
	...
	permissions_comment "forgejo.org/services/f3/permissions/comment"
...
func (o *comment) Get(ctx context.Context) bool {
	...
	f3_permissions.Check(ctx, permissions_comment.Get(f3_tree.GetProjectID(node), o.getIssueOrPullRequestAbsoluteID(ctx, node), o.forgejoComment), "GET /repos/{username}/{reponame}/issues/comments/{id}")
